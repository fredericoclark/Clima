    ...
    internal static class Program
    {
        ...
        private static void Main()
        {
            try
            {
                ...
                ServiceRuntime.RegisterServiceAsync("APIClimaType",
                    context => new APIClima(context)).GetAwaiter().GetResult();

                ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(APIClima).Name);
